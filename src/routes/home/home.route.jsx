      ...
      if (uploadResponse.ok) {
        ...
        if (processResponse.ok) {
          ...
          const transcribeFilesResponse = await fetch(
            `http://127.0.0.1:8000/transcribefiles/?foldername=${processData.foldername}`,
            {
              method: 'GET',
            }
          );
  ...
  return (
    <>
      <div className='app-container'>
        ...
        <DownloadModal showModal={showModal} />
